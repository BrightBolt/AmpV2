...
namespace AmpMod.Modules
{
    internal static class Asset
    {
        ...
        internal static void PopulateAssets()
        {
            ...
            //on heatshock use
            heatHit = Asset.LoadEffect("heatHit");
            heatSwing = Asset.LoadEffect("heatSwing 1", true);
            CreateHeatExplosion();
        ...
        {
            swordSwingEffect = Asset.LoadEffect("StormbladeSwing", true);
            swordHitImpactEffect = Asset.LoadEffect("StormbladeHit");
            swordSwingEffectRed = Asset.LoadEffect("StormbladeSwingRed", true);
            swordHitImpactEffectRed = Asset.LoadEffect("StormbladeHitRed");
        ...
        public static Material CreateMaterial(string materialName, float emission, Color emissionColor, float normalStrength)
        {
         /*   if (!commandoMat) commandoMat = RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/CharacterBodies/CommandoBody").GetComponentInChildren<CharacterModel>().baseRendererInfos[0].defaultMaterial;
            ...
            Material mat = Asset.mainAssetBundle.LoadAsset<Material>(materialName);
