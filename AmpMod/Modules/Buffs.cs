...
namespace AmpMod.Modules
{
    public static class Buffs
    {
        ...
        {
            //charge debuff
            chargeBuildup = AddNewBuff("AmpChargeBuildup", Modules.Asset.mainAssetBundle.LoadAsset<Sprite>("texChargeDebuffAlt"), new Color32(0, 145, 255, 255), true, true);
            electrified = AddNewBuff("AmpElectrified", Modules.Asset.mainAssetBundle.LoadAsset<Sprite>("texElectrified"), new Color32(76, 206, 255, 255), false, true);
            ...
            controlledCharge = AddNewBuff("NemesisAmpContolledCharge", Modules.Asset.mainAssetBundle.LoadAsset<Sprite>("texControlledChargeAlt"), new Color32(180, 71, 255, 255), true, true);
            damageGrowth = AddNewBuff("NemesisAmpDamageGrowth", null, new Color32(61, 0, 0, 0), true, false, true);
            nemAmpAtkSpeed = AddNewBuff("nemAmpAtkSpeed", Modules.Asset.mainAssetBundle.LoadAsset<Sprite>("texFieldAtkSpeedCombined"), new Color32(180, 71, 255, 255), false, false);
